...
@NamedQueries({
    ...
    , @NamedQuery(name = "Clientes.findByNroTarjeta", query = "SELECT c FROM Clientes c WHERE c.nroTarjeta = :nroTarjeta")
...
public class Clientes implements Serializable {
    ...
    public String toString() {
        return "org.innova.entity.Clientes[ idCliente=" + idCliente + " ]";
    }
